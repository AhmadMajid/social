...
ActiveRecord::Schema[7.0].define(version: 2023_04_16_105317) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.index ["user_id", "vibration_id"], name: "index_bookmarks_on_user_id_and_vibration_id", unique: true
    t.index ["user_id"], name: "index_bookmarks_on_user_id"
    t.index ["vibration_id"], name: "index_bookmarks_on_vibration_id"
  end
  ...
  create_table "hashtags_vibrations", id: false, force: :cascade do |t|
    t.bigint "hashtag_id"
    t.bigint "vibration_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["hashtag_id"], name: "index_hashtags_vibrations_on_hashtag_id"
    t.index ["vibration_id"], name: "index_hashtags_vibrations_on_vibration_id"
  end
  ...
  create_table "vibrations", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "body"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    ...
    t.integer "reply_vibrations_count", default: 0, null: false
  ...
  create_table "views", force: :cascade do |t|
    ...
    t.index ["vibration_id"], name: "index_views_on_vibration_id"
  end
